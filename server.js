...
// إضافة إعلان جديد
app.post('/api/advertisements', upload.array('adImages', 10), (req, res) => {
  try {
    ...
    const durationDays = parseInt(adDuration) || 1;
    ...
    const ad = {
      ...
      closable: adClosable === 'true' || adClosable === true,
      createdAt: new Date(),
      expiresAt: expiresAt,
      views: 0,
      clicks: 0
    ...
    res.json({ success: true, message: 'تم إنشاء الإعلان بنجاح', ad });
  } catch (error) {
